...
"Compressing the module xTestResource to $env:TEMP\xDismFeature_1.0.0.zip" | Write-Host
Add-Type -A System.IO.Compression.FileSystem
[IO.Compression.ZipFile]::CreateFromDirectory($testModulePath, "$env:TEMP\xDismFeature_1.0.0.zip")
...
Move-Item -Path $env:TEMP\xDismFeature_1.0.0.zip -Destination "$moduleUploadFolder"
