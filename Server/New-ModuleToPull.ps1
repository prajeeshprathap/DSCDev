...
"Compressing the module xDismFeature to $env:TEMP\xDismFeature.1.0.0.zip" | Write-Host
Add-Type -A System.IO.Compression.FileSystem
[IO.Compression.ZipFile]::CreateFromDirectory($testModulePath, "$env:TEMP\xDismFeature.1.0.0.zip")
...
Move-Item -Path $env:TEMP\xDismFeature.1.0.0.zip -Destination "$moduleUploadFolder"
